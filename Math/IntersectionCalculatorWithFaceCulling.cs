...
namespace Math
{
    public sealed class IntersectionCalculatorWithFaceCulling : IIntersectionCalculator
    {
        Position IIntersectionCalculator.RayHitsTriangle(double[] orig, double[] dir, double[] vert0, double[] vert1, double[] vert2)
        {
            double[] result = new double[3];

            if (IntersectTriangleWithFaceCulling(orig, dir, vert0, vert1, vert2, result) == 1)
                return new Position
                {
