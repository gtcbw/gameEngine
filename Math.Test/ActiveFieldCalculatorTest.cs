...
namespace Math.Test
{
    ...
    public class ActiveFieldCalculatorTest
    {
        ...
        public void AllFieldsAreFound()
        {
            ...
            Assert.IsNotNull(result.FirstOrDefault(x => x.X == 0 && x.Z == 0 && x.ID == 0 && x.RelativeID == 0));
            Assert.IsNotNull(result.FirstOrDefault(x => x.X == 1 && x.Z == 0 && x.ID == 1 && x.RelativeID == 1));
            Assert.IsNotNull(result.FirstOrDefault(x => x.X == 2 && x.Z == 0 && x.ID == 2 && x.RelativeID == 2));

            Assert.IsNotNull(result.FirstOrDefault(x => x.X == 0 && x.Z == 1 && x.ID == 3 && x.RelativeID == 3));
            Assert.IsNotNull(result.FirstOrDefault(x => x.X == 1 && x.Z == 1 && x.ID == 4 && x.RelativeID == 4));
            Assert.IsNotNull(result.FirstOrDefault(x => x.X == 2 && x.Z == 1 && x.ID == 5 && x.RelativeID == 5));

            Assert.IsNotNull(result.FirstOrDefault(x => x.X == 0 && x.Z == 2 && x.ID == 6 && x.RelativeID == 6));
            Assert.IsNotNull(result.FirstOrDefault(x => x.X == 1 && x.Z == 2 && x.ID == 7 && x.RelativeID == 7));
            Assert.IsNotNull(result.FirstOrDefault(x => x.X == 2 && x.Z == 2 && x.ID == 8 && x.RelativeID == 8));
        }
